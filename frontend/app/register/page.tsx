    ...
    <div className="min-h-screen bg-[#030712] text-white flex items-center justify-center px-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-white/40 text-sm">Start your creator journey today</p>
        </div>

        {/* Card */}
        <div className="bg-white/[0.04] border border-white/[0.08] rounded-2xl p-8">
          <h1 className="text-2xl font-black font-display text-white mb-1">Create your account</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={submitting || loading || !name || !email || !password || !confirmPassword}
