...
const Toast: React.FC<{ toast: ToastType }> = ({ toast }) => {
  ...
  const getStyles = () => {
    const baseStyles = 'flex items-start gap-3 p-4 rounded-lg shadow-lg backdrop-blur-sm border';
    ...
    >
      ...
      {toast.duration && toast.duration > 0 && (
        <div className="absolute bottom-0 left-0 right-0 h-1 bg-black bg-opacity-10">
          <div
            className="h-full bg-current opacity-50 transition-all duration-50 ease-linear"
